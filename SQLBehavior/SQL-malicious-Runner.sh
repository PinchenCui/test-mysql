...
log_file=/home/vm-0/malicious-$1-record.$( date "+%m-%d-%H:%M:%S" ).txt
...
hydra -l pinchen -P /home/vm-0/Downloads/SQLBehavior/password.list 172.17.0.2 ssh &
sleep 3
pkill hydra
}
...
if [[ $malware_flag -eq 0 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Bodoor-b448121b9caa65c119dacbaa3dc06649 /tmp/Virus/Backdoor.Linux.Bodoor-b448121b9caa65c119dacbaa3dc06649
...
if [[ $malware_flag -eq 1 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Dofloo.b-08e3dbc7c863b1a28701370a762a59b7 /tmp/Virus/Backdoor.Linux.Dofloo.b-08e3dbc7c863b1a28701370a762a59b7
...
if [[ $malware_flag -eq 2 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Katien.d-1d1a7c789bd31b95622e8a907e3d675e /tmp/Virus/Backdoor.Linux.Katien.d-1d1a7c789bd31b95622e8a907e3d675e
...
if [[ $malware_flag -eq 3 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Roopre.d-89b499443277150802e7f323930c8601 /tmp/Virus/Backdoor.Linux.Roopre.d-89b499443277150802e7f323930c8601
...
if [[ $malware_flag -eq 4 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.SpyEye.q-a168b7097dda3d7f600afbfcc19d4c4b /tmp/Virus/Backdoor.Linux.SpyEye.q-a168b7097dda3d7f600afbfcc19d4c4b
...
if [[ $malware_flag -eq 5 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Gafgyt.ak-a282f3285e8c00df98e02c5a6ef63cfe /tmp/Virus/Backdoor.Linux.Gafgyt.ak-a282f3285e8c00df98e02c5a6ef63cfe
...
if [[ $malware_flag -eq 6 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.PKC.a-18d978da1f3dd0c66dceffa29403d812 /tmp/Virus/Backdoor.Linux.PKC.a-18d978da1f3dd0c66dceffa29403d812
...
if [[ $malware_flag -eq 7 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Wirenet.a-9a0e765eecc5433af3dc726206ecc56e /tmp/Virus/Backdoor.Linux.Wirenet.a-9a0e765eecc5433af3dc726206ecc56e
...
if [[ $malware_flag -eq 8 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Backdoor.Linux.Tsunami.gen-7569ea823263531ee59528990d154fe6 /tmp/Virus/Backdoor.Linux.Tsunami.gen-7569ea823263531ee59528990d154fe6
...
if [[ $malware_flag -eq 9 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Flooder.Linux.Small.r-c149edb0d281bfd57a6dc53380eb022f /tmp/Virus/Flooder.Linux.Small.r-c149edb0d281bfd57a6dc53380eb022f
...
if [[ $malware_flag -eq 10 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Linux.Ganiw.d-7558b89eb6b61d691470b3f6b7eff249 /tmp/Virus/HEUR:Backdoor.Linux.Ganiw.d-7558b89eb6b61d691470b3f6b7eff249
...
if [[ $malware_flag -eq 11 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Linux.IrcShell.p-3f1d61809dbc78001c13d359584bdac9 /tmp/Virus/HEUR:Backdoor.Linux.IrcShell.p-3f1d61809dbc78001c13d359584bdac9
...
if [[ $malware_flag -eq 12 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Linux.Ropys.a-3e3de18adb102efcdff92a6ed5522be7 /tmp/Virus/HEUR:Backdoor.Linux.Ropys.a-3e3de18adb102efcdff92a6ed5522be7
...
if [[ $malware_flag -eq 13 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Linux.Sshgo.a-fe82c7fbcac1b1868a3c8401ea906bf1 /tmp/Virus/HEUR:Backdoor.Linux.Sshgo.a-fe82c7fbcac1b1868a3c8401ea906bf1
...
if [[ $malware_flag -eq 14 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Linux.Tori.a-cd41c0e3d6aa075cbacadee78a42986c /tmp/Virus/HEUR:Backdoor.Linux.Tori.a-cd41c0e3d6aa075cbacadee78a42986c
...
if [[ $malware_flag -eq 15 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Linux.Vpnfilter.a-4912aad5e79c78bc143e71633df9c17b /tmp/Virus/HEUR:Backdoor.Linux.Vpnfilter.a-4912aad5e79c78bc143e71633df9c17b
...
if [[ $malware_flag -eq 16 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Backdoor.Multi.Mibsun.gen-84e3ad0d62d21739d632d2106864e79e /tmp/Virus/HEUR:Backdoor.Multi.Mibsun.gen-84e3ad0d62d21739d632d2106864e79e
...
if [[ $malware_flag -eq 17 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:DoS.Linux.Agent.bl-96f43bc0302b836a355130e599f88d7d /tmp/Virus/HEUR:DoS.Linux.Agent.bl-96f43bc0302b836a355130e599f88d7d
...
if [[ $malware_flag -eq 18 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Exploit.Linux.CVE-2016-5195.a-42ce5d5179304407b2c0197b78e5b7b0 /tmp/Virus/HEUR:Exploit.Linux.CVE-2016-5195.a-42ce5d5179304407b2c0197b78e5b7b0
...
if [[ $malware_flag -eq 19 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Exploit.Linux.Intfour.a-ff1e9d1fc459dd83333fd94dbe36229a /tmp/Virus/HEUR:Exploit.Linux.Intfour.a-ff1e9d1fc459dd83333fd94dbe36229a
...
if [[ $malware_flag -eq 20 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Exploit.Linux.Lotoor.bh-2ba254e843d46b542bf4a5626b833c5b /tmp/Virus/HEUR:Exploit.Linux.Lotoor.bh-2ba254e843d46b542bf4a5626b833c5b
...
if [[ $malware_flag -eq 21 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Exploit.Linux.Race.a-4a1e830050766ca432536408eca8c58c /tmp/Virus/HEUR:Exploit.Linux.Race.a-4a1e830050766ca432536408eca8c58c
...
if [[ $malware_flag -eq 22 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:HackTool.Linux.PNScan.a-e09f9afc6a7da198cb31ab71b0f8e174 /tmp/Virus/HEUR:HackTool.Linux.PNScan.a-e09f9afc6a7da198cb31ab71b0f8e174
...
if [[ $malware_flag -eq 23 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:HackTool.Linux.Portscan.b-a7bdcad5b9c29c9a4af5d45b79bf517a /tmp/Virus/HEUR:HackTool.Linux.Portscan.b-a7bdcad5b9c29c9a4af5d45b79bf517a
...
if [[ $malware_flag -eq 24 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Trojan-Banker.AndroidOS.Wroba.a-efea955550b8c192a3ecf8d320613aaf /tmp/Virus/HEUR:Trojan-Banker.AndroidOS.Wroba.a-efea955550b8c192a3ecf8d320613aaf
...
if [[ $malware_flag -eq 25 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Trojan-DDoS.Linux.Ddostf.a-aa16fd4728467155f02b3d5b33338f67 /tmp/Virus/HEUR:Trojan-DDoS.Linux.Ddostf.a-aa16fd4728467155f02b3d5b33338f67
...
if [[ $malware_flag -eq 26 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Trojan-DDoS.Linux.Sotdas.a-7c2044998e56d6edef5562dab3b07ee5 /tmp/Virus/HEUR:Trojan-DDoS.Linux.Sotdas.a-7c2044998e56d6edef5562dab3b07ee5
...
if [[ $malware_flag -eq 27 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Trojan-DDoS.Linux.Znaich.a-dce96b0c1968a2f58da7a28bff295f77 /tmp/Virus/HEUR:Trojan-DDoS.Linux.Znaich.a-dce96b0c1968a2f58da7a28bff295f77
...
if [[ $malware_flag -eq 28 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HEUR:Worm.Linux.Pilkah.gen-ac2c9ce2b3edf07045024d60f9b4e53e /tmp/Virus/HEUR:Worm.Linux.Pilkah.gen-ac2c9ce2b3edf07045024d60f9b4e53e
...
if [[ $malware_flag -eq 29 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HackTool.Linux.ProcHider.b-d5290df2b8797b360651ae2a9efbd829 /tmp/Virus/HackTool.Linux.ProcHider.b-d5290df2b8797b360651ae2a9efbd829
...
if [[ $malware_flag -eq 30 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/HackTool.Linux.Sshbru.i-792b3b390c9597bafda3f2c27b18cacb /tmp/Virus/HackTool.Linux.Sshbru.i-792b3b390c9597bafda3f2c27b18cacb
...
if [[ $malware_flag -eq 31 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Linux.Trojan.Setag.SwujfromTencentdetection...-c819b1705f2938ac258397c29618fceb /tmp/Virus/Linux.Trojan.Setag.SwujfromTencentdetection...-c819b1705f2938ac258397c29618fceb
...
if [[ $malware_flag -eq 32 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Trojan-DDoS.Linux.DnsAmp.a-a4eecf76f4c90fb8065800d4cad391df /tmp/Virus/Trojan-DDoS.Linux.DnsAmp.a-a4eecf76f4c90fb8065800d4cad391df
...
if [[ $malware_flag -eq 33 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Trojan-DDoS.Linux.Xarcen.a-9e3f2816aedb9f6fcf1b614c0a9aa0f3 /tmp/Virus/Trojan-DDoS.Linux.Xarcen.a-9e3f2816aedb9f6fcf1b614c0a9aa0f3
...
if [[ $malware_flag -eq 34 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Trojan-Downloader.Linux.Mirai.d-261c6cbdfb899acc8111d49487976de2 /tmp/Virus/Trojan-Downloader.Linux.Mirai.d-261c6cbdfb899acc8111d49487976de2
...
if [[ $malware_flag -eq 35 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Trojan-Downloader.Linux.ShellLoader.a-8d59c7b144e8733cabdd453582045582 /tmp/Virus/Trojan-Downloader.Linux.ShellLoader.a-8d59c7b144e8733cabdd453582045582
...
if [[ $malware_flag -eq 36 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Trojan-Ransom.Linux.Cryptor.b-1e19b857a5f5a9680555fa9623a88e99 /tmp/Virus/Trojan-Ransom.Linux.Cryptor.b-1e19b857a5f5a9680555fa9623a88e99
...
if [[ $malware_flag -eq 37 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Trojan-Spy.Linux.Pymadro.a-fcbfb234b912c84e052a4a /tmp/Virus/Trojan-Spy.Linux.Pymadro.a-fcbfb234b912c84e052a4a
...
if [[ $malware_flag -eq 38 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/Virus.Linux.RST.b-f7e34d56daae900fd925fbf252f20139 /tmp/Virus/Virus.Linux.RST.b-f7e34d56daae900fd925fbf252f20139
...
if [[ $malware_flag -eq 39 ]]; then
	...
	sudo docker exec -i test-mysql sshpass -p pinchen scp vm-0@172.17.0.1:/home/vm-0/Documents/Virus/not-a-virus:HEUR:RiskTool.Linux.BitCoinMiner.b-5435e38d7bfcc398beeb3eae8100589e /tmp/Virus/not-a-virus:HEUR:RiskTool.Linux.BitCoinMiner.b-5435e38d7bfcc398beeb3eae8100589e
...
{
logger "SQL Delete"
sudo docker exec -i test-mysql mysql -uroot -ppinchen < /home/vm-0/Downloads/SQLBehavior/delete.sql 2> /dev/null
}

SQL_misbeharvior_injection ()
{
logger "SQL Injection"
sudo docker exec -i test-mysql mysql -uroot -ppinchen < /home/vm-0/Downloads/SQLBehavior/injection.sql 2> /dev/null
}
...
rm /home/vm-0/Downloads/SQLBehavior/hydra.restore
...
while [[  $(($(date +%s) - $start )) -le $2 ]]; do
	flag_num=$(( ( $RANDOM % 10 )  + 1  ))
	echo -n "Flag bit is $flag_num..."
	if [[ $flag_num -ge 8 ]]; then #change this number to have more attacks
		if [[ "$1" == "python" ]]; then
			python_runner
			python_counter=$(( python_counter+  1 ))
		fi
